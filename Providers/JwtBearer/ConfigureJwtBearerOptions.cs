...
public class ConfigureJwtBearerOptions(IOptions<JwtProviderOptions> jwtBearerProviderOptions)
    : IConfigureNamedOptions<JwtBearerOptions>
{
    private readonly IOptions<JwtProviderOptions> _jwtBearerProviderOptions = jwtBearerProviderOptions ?? throw new ArgumentNullException(nameof(jwtBearerProviderOptions));
