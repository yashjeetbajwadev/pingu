...
namespace pingu.Providers.Messaging.Twilio;

public class TwilioHandler(
    IOptions<TwilioSenderOptions> messageSenderOptions,
    ILogger<TwilioHandler> messageSenderLogger)
    : IMessageHandler
{
    private readonly IOptions<TwilioSenderOptions> _messageSenderOptions = messageSenderOptions ?? throw new ArgumentNullException(nameof(messageSenderOptions));
    private readonly ILogger<TwilioHandler> _messageSenderLogger = messageSenderLogger ?? throw new ArgumentNullException(nameof(messageSenderLogger));
