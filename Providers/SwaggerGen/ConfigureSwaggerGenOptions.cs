...
namespace pingu.Providers.SwaggerGen;

public class ConfigureSwaggerGenOptions(IHttpContextAccessor httpContextAccessor) : IConfigureOptions<SwaggerGenOptions>
{
